    ...
    glycolHeat: useMutation(
      ...
      { 
        ...
        onError: (error) => {
          ...
          alert(`Glycol heater contro          console.log('Kettle heater power consumption:', response.data)
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <ControlCard
              ...
              status={(() => {
                ...
                return (power || 0) > 0 ? "On" :                // Use local state from API response (power consumption number)
